    ...
    <div class="container px-lg-5">
        <div class="row g-4">
            ...
            <div class="carousel-inner">
                ...
                <img src="img/computer.jpg" class="d-block w-100" style="height:450px;"  alt="...">
                </div>
                <div class="carousel-item">
                <img src="img/print2.jpg" class="d-block w-100" style="height:450px;" alt="...">
                </div>
                <div class="carousel-item">
                <img src="img/print.jpg" class="d-block w-100" style="height:450px;" alt="...">
                </div>
            </div>
...
<div class="container-xxl py-5">
    <div class="container py-5 px-lg-5">
        <div class="wow fadeInUp" data-wow-delay="0.1s">
            <p class="section-title text-secondary justify-content-center"><span></span>Comprehensive Services<span></span></p>
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item d-flex flex-column text-center rounded">
                    ...
                    <p class="m-0">Increase your online visibility and drive organic traffic to your website with our strategic SEO services. Our team of SEO experts will optimize your website's structure, content, and performance to improve its ranking in search engine results pages (SERPs) and attract qualified leads to your business.</p>
                    <a class="btn btn-square" href="service.php"><i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item d-flex flex-column text-center rounded">
                    ...
                    <h5 class="mb-3">Strategic Digital Marketing</h5>
                    <p class="m-0">We begin by understanding your business goals, target audience, and industry landscape to develop a tailored digital marketing strategy that aligns with your objectives. Whether you're looking to increase brand awareness, drive website traffic, or boost conversions, we'll craft a roadmap to success that leverages the most effective digital channels and tactics.</p>
                    <a class="btn btn-square" href="service.php"><i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex flex-column text-center rounded">
                    ...
                    <p class="m-0">Engage with your audience, build brand loyalty, and drive conversions through our social media marketing services. We'll develop a comprehensive social media strategy tailored to your brand, create compelling content, manage your social media profiles, and analyze performance to ensure maximum impact and ROI.</p>
                    <a class="btn btn-square" href="service.php"><i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item d-flex flex-column text-center rounded">
                    ...
                    <p class="m-0">Nurture leads, drive conversions, and increase customer retention with targeted email marketing campaigns. Our email marketing services encompass everything from campaign strategy and design to list segmentation, automation, and performance tracking, ensuring your messages reach the right people at the right time.</p>
                    <a class="btn btn-square" href="service.php"><i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item d-flex flex-column text-center rounded">
                    ...
                    <p class="m-0">Maximize your reach and drive targeted traffic to your website through strategic PPC advertising campaigns. From keyword research and ad copywriting to campaign management and optimization, we'll help you leverage platforms like Google Ads and social media advertising to reach your ideal audience and achieve your advertising goals.</p>
                    <a class="btn btn-square" href="service.php"><i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex flex-column text-center rounded">
                    ...
                    <h5 class="mb-3">Conversion Rate Optimization </h5>
                    <p class="m-0">Optimize your website and marketing assets to maximize conversions and drive measurable results. Through strategic analysis, A/B testing, and optimization techniques, we'll identify barriers to conversion and implement solutions to enhance user experience and increase conversion rates across your digital channels.</p>
                    <a class="btn btn-square" href="service.php"><i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
